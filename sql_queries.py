...
songplay_table_create = ("""create table songplays(songPlayID serial primary key,userId int,ts bigint,songID varchar,artistID varchar,level varchar,itemInSession int,page varchar, userAgent varchar,length decimal
...
song_table_create = ("""create table songs(songID varchar,title text,artistID varchar,duration decimal,year int,primary key(songID))
""")
...
song_select = ("""select s.songID,s.artistID from songs s inner join artists a on a.artistID=s.artistID
